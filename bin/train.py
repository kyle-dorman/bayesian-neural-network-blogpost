...
flags.DEFINE_boolean('augment', False, 'Whether open augmented data or initial data.')
...
def main(_):
	...
	((x_train, y_train), (x_test, y_test)) = test_train_batch_data(FLAGS.dataset, FLAGS.encoder, FLAGS.debug, FLAGS.augment)
